...
<body>
  <header>
    <h1 class="logo">Chat with {{.who}}</h1>
      <pre id="output"></pre>
      ...
      <script>
          ...
          var socket = new WebSocket("ws://" + window.location.hostname + ":8080/startchat/{{.session}}");
          ...
          socket.onerror = function(event) {
            output.innerHTML += "WebSocket error observed: "  + event.data;
          };
